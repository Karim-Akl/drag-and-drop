...
const DndExample = () => {
  ...
  const saveChangesToApi = async (dataToSave: any) => {
    try {
      ...
      toast.success("Changes saved successfully!"); // Add this line to show a success toast
    } catch (error) {
      console.error("Error sending data to API:", error);
      toast.error("Failed to save changes!"); // Add this line to show an error toast
    }
  };
